...
class Almacenes extends CI_Controller {
	...
	public function index() {
		...
		$crud->columns('COD_ALMACEN', 'NOMBRE_ALMACEN', 'DIRECCION', 'DESCRIPCION');
		$crud->fields('COD_ALMACEN', 'NOMBRE_ALMACEN', 'DIRECCION', 'DESCRIPCION', 'USUARIO_CREACION', 'USUARIO_MODIFICACION');
		$crud->change_field_type('USUARIO_CREACION','invisible');
		$crud->change_field_type('USUARIO_MODIFICACION','invisible');
		//Campos requeridos
		$crud->required_fields('COD_ALMACEN','NOMBRE_ALMACEN', 'DIRECCION');
...
//				show_error('LMTF');
	...
	public function georeferenciar($codAlmacen) {
		...
		$data['COD_ALMACEN'] = $codAlmacen;

		$breadCrumb = cargarBreadCrumb($this->menuId, 'georeferencia', $result['COD_ALMACEN']);
