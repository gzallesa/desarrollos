<?php echo form_open('rol/rol_menu_web',array( 'id' => 'ff','data-options'=>'ajax:false')); ?> 
...
<!-- grupos de asignacion -->
    <div class="easyui-panel" title="Asignar Menus Web" style="width:600px;height:300px;" data-options="border:false">
            <div class="easyui-layout" data-options="fit:true">
                <div data-options="region:'west'" style="width:250px">
                    <ul class="easyui-datalist" title="Menus web disponibles" lines="true" style="width:245px;height:260px" id="listaAsignar" >
        <?= $datosMenuWebAAsignar;  ?>
        </ul>
                </div>
                <div data-options="region:'east'" style="width:250px">
                    <ul id="listaAsignados"  class="easyui-datalist" title="Menus web asignados" lines="true" style="width:240px;height:260px"  >
        <?= $datosMenuWebAsignados;  ?>
                </div>
