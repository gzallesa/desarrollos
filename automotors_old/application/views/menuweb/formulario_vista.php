<?php echo form_open('menuweb/guardar_menu_web',array( 'id' => 'ff','data-options'=>'ajax:false')); ?> 
...
<?php if(isset($mensaje)):
        if($mensaje["@estado"]=="0"){
 ?>
    <div  class="report-div success" style="display: block;"><p>Sus datos han sido guardados correctamente.  <a href="<?= base_url()  ?>menuweb">Volver a la lista</a></div>
<?php } else{ ?>
...
<script>
    ...
    function cancelar(){
        window.location.href ="<?= base_url() ?>menuweb";
    }
    var datos=<?= $json ?>;
