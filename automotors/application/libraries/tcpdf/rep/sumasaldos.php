...
<tr nobr="true"><th colspan="4" align="center" height="50px" valign="midle" ><h3>SUMAS Y SALDOS</h3><br>DEL $del AL $al<br><br>(expresado en $descripcionmoneda)<br><br></th></tr></table>
EOD;
