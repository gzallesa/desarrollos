<?php echo form_open('camiones/camion_chofer',array( 'id' => 'ff','data-options'=>'ajax:false')); ?> 
<div class="easyui-panel" style="width:100%;max-width:700px;padding:30px 60px;">
	<div style="margin-bottom:20px;text-align:center;">
		<select id="cc" class="easyui-combobox" name="idCamion" style="width:300px;" data-options="
	        valueField:'cod_camion',
    ...
    <div class="easyui-panel" title="Asignar Chofer" style="width:600px;height:300px;" data-options="border:false">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'west'" style="width:250px">
                <ul class="easyui-datalist" title="Choferes disponibles" lines="true" style="width:245px;height:260px" id="listaAsignar">
		        	<?= $datosCamionChoferAAsignar;  ?>
		        </ul>
            </div>
            <div data-options="region:'east'" style="width:250px">
                <ul id="listaAsignados" class="easyui-datalist" title="Choferes asignados" lines="true" style="width:240px;height:260px">
    				<?= $datosCamionChoferAsignados;  ?>
    			</ul>
            </div>
