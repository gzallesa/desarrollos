<script type="text/javascript">
    ...
    function BotonesAccion(value,row){
        ...
        var accionEditar = 'window.location.href = \'<?= base_url() ?>menuweb/editar_menu_web/'+row.menu+'\'';
...
<!--/ mensaje de exito -->
    ...
    <div id="tb">
    <?php if(isset($acc_registrar) && $acc_registrar == 'MW_I'):?>
    	<a href="<?= base_url() ?>menuweb/agregar_menu_web" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">Nuevo Menu</a>
    <?php endif;?>
    </div>
...
<script type="text/javascript">
    ...
    function eliminar(id,nombre)
    {
        ...
        if (r == true) {
            window.location.href = "<?= base_url() ?>menuweb/eliminar_menu_web/"+id;
        } 
    }
    ...
    function activar(id,nombre)
    {
        ...
        if (r == true) {
            window.location.href = "<?= base_url() ?>menuweb/activar_menu_web/"+id;
        } 
    }
</script>