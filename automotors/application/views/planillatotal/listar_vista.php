<?php echo form_open('planillatotal',array( 'id' => 'ff','data-options'=>'ajax:false')); ?> 
<div class="easyui-panel" style="width:100%;max-width:100%;padding:40px 10px;">
        <div style="margin-bottom:20px;text-align:center;">
            ...
            <p>
            <?php if(isset($acc_generar) && $acc_generar == 'PT_G'):?>
    ...
    <table id="tt" class="easyui-datagrid" width="100%"
            title="Planilla Total" iconCls="icon-save"
    ...
    <div id="toolbar">
    	<?php if(isset($acc_exportar) && $acc_exportar == 'PT_E'):?>
...
<script>
	...
	function toExcel(){
		$('#tt').datagrid('toExcel','PlanillaTotal_<?= $periodo ?>.xls');
	}
