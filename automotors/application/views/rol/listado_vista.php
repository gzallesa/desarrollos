...
<div id="toolbar">
    ...
    <div style="margin-bottom:20px">
		<input class="easyui-textbox" label="" labelPosition="top" style="width:20%;height:32px"  id="n_buscar" name="n_buscar" value="">
	    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" style="height:32px" onclick="doSearch()">Buscar</a>
    </div>
</div>
