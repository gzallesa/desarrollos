...
$.fn.eventCalendar = function(options){
	...
	function dateSlider(show, year, month) {
		var $eventsCalendarSlider = $("<div class='eventsCalendar-slider'></div>"),
			...
			$eventsCalendarArrows = $("<a href='#' class='arrow previ'><span>" + eventsOpts.txt_prev + "</span></a><a href='#' class='arrow nexti'><span>" + eventsOpts.txt_next + "</span></a>");
	...
	function getEventsData(data, limit, year, month, day, direction){
		...
		if (!direction) {
			...
			if (day != '') {
				subtitle.html(eventsOpts.txt_SpecificEvents_prev + eventsOpts.monthNames[month] + " " + num_abbrev_str(day) +" "+year+ " " + eventsOpts.txt_SpecificEvents_after);
			} else {
...
$.fn.eventCalendar.defaults = {
	...
	txt_noEvents: "<button onclick="+String.fromCharCode(39)+"nuevaActividad();"+String.fromCharCode(39)+">Nueva Actividad</button>",
	txt_SpecificEvents_prev: "",
	txt_SpecificEvents_after: "eventos:",
	txt_next: "next",
	txt_prev: "prev",
	txt_NextEvents: "Eventos:",
