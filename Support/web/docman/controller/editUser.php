...
<form onsubmit="return false;" id="frmuser">
            <table class="newUser">
            <tr><td>Nombre(s) y Apellido(s):</td><td><input type="text" name="nombre" value="'.$u->getName().'"  onchange="verifica(this,0);" onkeyup="verifica(this,0);"></td></tr>
            <tr><td>CI:</td><td><input type="text" name="ci" value="'.$u->getCI().'"  onchange="verifica(this,3);" onkeyup="verifica(this,3);"></td></tr>
            <tr><td>E-mail:</td><td><input type="text" name="email" value="'.$u->getEmail().'"  onchange="verifica(this,2);" onkeyup="verifica(this,2);"></td></tr>
                <tr><td>Nombre de usuario:</td><td><input type="text" name="username" value="'.$u->getUserName().'"  onchange="verifica(this,0);" onkeyup="verifica(this,0);"></td></tr>
            ...
            <tr><td></td><td><button class="button" onclick="actualizarUsuario('.$u->getIDU().');">Guardar Cambios</button><button class="button" onclick="cerrar();">Cancelar</button></td></tr>
            </table></form>    
';
?>
