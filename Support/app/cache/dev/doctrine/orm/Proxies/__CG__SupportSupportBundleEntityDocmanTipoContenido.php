 ...
 */
class DocmanTipoContenido extends \Support\SupportBundle\Entity\DocmanTipoContenido implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'descripcion', 'path');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DocmanTipoContenido $proxy) {
